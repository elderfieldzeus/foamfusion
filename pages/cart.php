    ...
    <div class="flex">
        <div class="w-3/4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-6 product-grid">
                ...
                <div id="product-<?php echo $variation['VariationID']; ?>" class="bg-white p-6 rounded-lg shadow-md product">
                    <h2 class="text-xl font-bold mb-2 variation-name"><?php echo $variation['VariationName']; ?></h2>
                    <p class="text-gray-700 mb-2 variation-description"><?php echo $variation['VariationDescription']; ?></p>
                    <p class="text-gray-700 mb-2">Product Name: <?php echo $variation['ProductName']; ?></p>
                    <img src="<?php echo $variation['VariationImage']; ?>" alt="<?php echo $variation['VariationName']; ?>" class="w-full h-48 object-cover mb-4">
                    <p class="text-gray-700 mb-2 variation-price">₱<?php echo $variation['UnitPrice']; ?></p>
                    <p class="text-gray-700 mb-2">In Stock: <?php echo $variation['InStock']; ?></p>
                    <input type="number" value="1" min="1" max="<?php echo $variation['InStock']; ?>" class="quantity-input w-16 p-1 border rounded mb-4">
                    <button class="bg-blue-500 text-white px-4 py-2 rounded" onclick="addToCart(<?php echo $variation['VariationID']; ?>)">Add to Cart</button>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
