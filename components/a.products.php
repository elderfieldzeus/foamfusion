    ...
    <div id="product_dialog_<?= $row['VariationID'] ?>" class="dialog hidden">
        <div class="inner_dialog">
            ...
            <div class="flex w-full h-full">
                ...
                <div class="right_dialog w-1/2 flex items-center justify-center">
                    <form class="wrapper h-[30rem] w-[30rem] flex flex-col justify-between">
                        <div class="h-20rem">
                            ...
                            <p class="text-xl"><input class="focus:outline-none bg-opacity-0 " value="<?=$row['VariationName']?>"></p>
                            <p class="text-lg mt-4">Mass: <input class="focus:outline-none bg-opacity-0" min="0" value="<?=$row['MassInOZ']?>oz"></p>
                            <p class="text-lg">Price: Php <input type="numeric" class="focus:outline-none bg-opacity-0" min="0" value="<?=$row['UnitPrice']?>"></p>
                            <p class="text-lg">In stock: <input type="numeric" class="focus:outline-none bg-opacity-0" min="0" value="<?=$row['InStock']?>"></p>
                            <p class="text-xl mt-4">Product Description</p>
                            <textarea class="focus:outline-none bg-opacity-0 text-lg w-full h-56 resize-none overflow-y-scroll"><?=$row['VariationDescription']?></textarea>
                        </div>
