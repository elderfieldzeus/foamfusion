<?php
    ...
    if(isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirm_password']) && isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['phone_num']) && isset($_POST['birthdate']) && isset($_POST['city']) && isset($_POST['barangay']) && isset($_POST['street_name']) && isset($_POST['postal_code'])) {
