        ...
        <div id="order_dialog_<?= $row['OrderID'] ?>" class="dialog hidden">
            <div class="inner_dialog">
                ...
                <div>
                    ...
                    ?>
                        <div class="flex justify-between">
                            <p class=<?= $cd_row['VariationID'] ? "text-gray-500" : "text-red-500" ?> ><?= ($cd_row['VariationID'] ? $cd_row['ProductName'] . ', '  . $cd_row['VariationName'] . ' (' . $cd_row['MassInOZ'] . 'oz)' : '**DELETED PRODUCT**')   ?> @Php<?= $cd_row['OrderedPrice'] ?> x <?= $cd_row['OrderedQuantity'] ?>pc/s</p>
